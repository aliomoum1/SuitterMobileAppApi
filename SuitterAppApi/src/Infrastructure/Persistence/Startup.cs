...
using Serilog;
using SuitterAppApi.Application.Common.Persistence;
using SuitterAppApi.Domain.Common.Contracts;
using SuitterAppApi.Infrastructure.Common;
using SuitterAppApi.Infrastructure.Persistence.ConnectionString;
using SuitterAppApi.Infrastructure.Persistence.Context;
using SuitterAppApi.Infrastructure.Persistence.Initialization;
using SuitterAppApi.Infrastructure.Persistence.Repository;

namespace SuitterAppApi.Infrastructure.Persistence;
internal static class Startup
{
    ...
    internal static IServiceCollection AddPersistence(this IServiceCollection services)
    {
        ...
        return services
            ...
            .AddServices(typeof(ICreator), ServiceLifetime.Transient)
            .AddTransient<FileCreator.FileCreator>()
