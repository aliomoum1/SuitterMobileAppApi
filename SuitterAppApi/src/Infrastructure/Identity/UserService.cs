...
using SuitterAppApi.Application.Common.Caching;
using SuitterAppApi.Application.Common.Events;
using SuitterAppApi.Application.Common.Exceptions;
using SuitterAppApi.Application.Common.FileStorage;
using SuitterAppApi.Application.Common.Interfaces;
using SuitterAppApi.Application.Common.Mailing;
using SuitterAppApi.Application.Common.Models;
using SuitterAppApi.Application.Common.Specification;
...
internal partial class UserService : IUserService
{
    ...
    public async Task<UserDetailsDto> GetByMobileAsync(string mobile, CancellationToken cancellationToken)
    {
        var user = await _userManager.Users
            .AsNoTracking()
            .Where(u => u.PhoneNumber == mobile)
            .FirstOrDefaultAsync(cancellationToken);
