...
namespace SuitterAppApi.Shared.Authorization;
public static class FSHAction
{
    ...
    public const string GetLastAppVersions = nameof(GetLastAppVersions);
...
public static class FSHResource
{
    ...
    public const string AppVersions = nameof(AppVersions);
}
...
public static class FSHPermissions
{
    private static readonly FSHPermission[] _all = new FSHPermission[]
    {
        ...
        new("Search AppVersions", FSHAction.Search, FSHResource.AppVersions, IsBasic: false),
        new("View AppVersions", FSHAction.GetLastAppVersions, FSHResource.AppVersions, IsBasic: true),
        new("Create AppVersions", FSHAction.Create, FSHResource.AppVersions),
        new("Update AppVersions", FSHAction.Update, FSHResource.AppVersions),
        new("Delete AppVersions", FSHAction.Delete, FSHResource.AppVersions),
        new("Export AppVersions", FSHAction.Export, FSHResource.AppVersions),
    };
